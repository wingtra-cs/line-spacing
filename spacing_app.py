...
st.sidebar.markdown('#')
st.sidebar.write('This application computes the flight line spacing for a given Wingtra payload.')
st.sidebar.write('Please note that these are approximate and ideal. Some variations in-field are expected.')
...
choice = st.selectbox('📷 Select Payload Used :',
    ('[Payload]', 'RGB61', 'RX1', 'a6100 Nadir', 'a6100 Oblique', 'Micasense RedEdge-P'))
